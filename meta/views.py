...
class Meta(object):
    ...
    def __init__(self, **kwargs):
        ...
        self.extra_props = kwargs.get('extra_props', settings.DEFAULT_EXTRA_PROPS)
        self.extra_custom_props = kwargs.get('extra_custom_props', settings.DEFAULT_EXTRA_CUSTOM_PROPS)
